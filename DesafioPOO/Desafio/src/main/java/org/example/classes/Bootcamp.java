...
public class Bootcamp {
    ...
    //hashset é usado por que a ordem é irrelevante, porém queremos que haja somente 1 dev, porque cada pessoa é única
    private Set<Conteudo> conteudos = new LinkedHashSet<>();
    //linkedhash porque é necessário que os conteúdos estejam em ordem e sejam únicos.
